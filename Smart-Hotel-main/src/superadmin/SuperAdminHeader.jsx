// File: /src/superadmin/SuperAdminHeader.jsx
    ...
    <>
      <header className="sa-header">
        <div className="left-section">
          <input className="sa-search" placeholder="Search..." />
        </div>
        ...
        <div className="right-section">
          ...
          <div className="profile-box">
            <img src="https://i.pravatar.cc/40?img=12" alt="profile" className="profile-img" />
